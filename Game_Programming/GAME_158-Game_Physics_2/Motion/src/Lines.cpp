...
public:
	...
	*/
    ...
    int draw(float xpos, float ypos, float rotate) {
        glUseProgram(shaderProgram);
 
	 glm::mat4 model = glm::mat4(1.0f);
    	// model = glm::translate(model, glm::vec3(startPoint.x, startPoint.y, 0.0f));  // first translate (transformations are: scale happens first, then rotation, and then final translation happens; reversed order)
