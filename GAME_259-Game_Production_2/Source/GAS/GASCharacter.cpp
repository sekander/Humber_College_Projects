...
UGASAbilitySystemComponent* AGASCharacter::GetAbilitySystemComponent()
{
	return AbilitySystemComponent;
}

void AGASCharacter::InitializeAtttributes()
{
...
void AGASCharacter::GiveAbilities()
{
	...
	{
		for (TSubclassOf<UGASGameplayAbility>& StatupAbility : DefaultAbilities)
		{
			AbilitySystemComponent->GiveAbility(
				FGameplayAbilitySpec(StatupAbility, 1,
					static_cast<int32>(StatupAbility.GetDefaultObject()->AbilityInputID), this)
			);
		}
	}
}
