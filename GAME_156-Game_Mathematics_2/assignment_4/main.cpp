...
//	plane p5(0,0,1,1);
	...
	cout << "\nPart 1\n";
	cout << "------------------------------------\n";
	cout << "Testing Vec3 Rotate\n\n";
	cout << "";
	vec_3 ro(1, 0, 0);
	cout << "Rotate this vector : ";
	ro.print_vec();
	cout << "by this Quaternion : ";
	Quaternion qz(0, 0, 0.7071, 0.7071);
	qz.print_quaternion();
	cout << "\nResults are : ";
	rotate(ro,qz).print_vec();


	//Part 2
	cout << "\nPart 2\n";
	cout << "------------------------------------\n";
	cout << "Testing Quaternion operator * (Quaternion otherQuat)\n\n";
	cout << "Multiply these two Quaternions : \n";
	...
	Quaternion nu_q(4, 1, 2, -3);
	Quaternion nu_qq(3, 1, -4, 1);
	
	auto qqq = nu_q * nu_qq;
	qqq.print_quaternion();
