...
class Physics
{
    public:
        ...
        Physics(Vector2D position, Vector2D velocity, Vector2D acceleration, Vector2D force,
	...
	//Calculate Position based on given velocity and acceleration
        void calculatePosition(Vector2D &position, Vector2D &velocity, Vector2D &acceleration, int time)
        {
	...
	//Calculate Linear Velocity of Physic object
        void calculateVelocity(Vector2D &velocity, Vector2D &acceleration, int time)
        {
	...
	//Calculate Linear Acceleration of Physic object
        void calculateAcceleration(Vector2D &force, int mass)
        {
	...
	//Calculate force thrust acted up Physic object 
        void calculateForce(Vector2D force, float theta)
        {
